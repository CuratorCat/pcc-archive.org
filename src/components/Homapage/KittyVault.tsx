        ...
        <div className="relative sm:grid md:grid-cols-2 lg:gap-8 lg:items-center bg-slate-500/10 hover:bg-slate-500/20 rounded-3xl px-8 py-8 md:py-12 group transition-all duration-300">
          ...
          <div className="relative">
            ...
            <p className="mt-6 text-center md:text-left text-base sm:text-xl lg:text-lg xl:text-xl">
              The KittyVault is a vault of NFTs that backs every PCC Cat and KV
              Purrks airdrops. The idea is that the Vault will operate as a
            ...
            <div className="block pt-8 pb-4 md:pb-0 text-center md:text-left">
              <Link to="/kittyvault">
                <span className="inline-block px-6 py-3 rounded-full bg-pink-500 hover:bg-white hover:shadow-lg hover:shadow-pink-500 text-base font-medium text-white hover:text-pink-500 transition-all duration-300">
                  Learn More
                </span>
              </Link>
            </div>
